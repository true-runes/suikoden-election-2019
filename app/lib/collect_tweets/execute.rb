class CollectTweets::Execute
  ...
  def call
    ...
    searched_tweets = object.search(target_search_word: '#幻水総選挙', target_since_id: TargetTweet.all.order("tweet_id desc").first.tweet_id, target_max_id: nil, target_count: 100)
